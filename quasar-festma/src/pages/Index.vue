<template>
  <q-page class="container scene">
    ...
    <a-scene arjs='debugUIEnabled: false;'>
        ...
        <a-marker id='cite' type='pattern' url='statics/marker/pt-cite.patt'>
            <a-plane src="statics/quadrado-magico-black.jpg" scale="5.3 5.3 5.3" rotation="-90 0 0" position="0 0 -3">
            </a-plane>
        ...
        <a-marker id='frac1' type='pattern' url='statics/marker/pt-frac1.patt'>
            ...
            <a-plane src="statics/disponibilita.jpg" width="3.8" height="5.1" rotation="-90 0 0">
            </a-plane>
        </a-marker>

        <a-marker id='frac2' type='pattern' url='statics/marker/pt-frac2.patt'>
            <a-plane src="statics/ladder.png" scale="2 2 2" height="2.5" width="2" rotation="-8 0 0" position="0 0 -1.5">
            </a-plane>
        </a-marker>

        <a-assets>
            <video id="vid" src="statics/peticov_animation.mp4" loop="true" crossorigin muted="muted"></video>
        </a-assets>
        ...
        <a-marker id='frac4' type='pattern' url='statics/marker/pt-frac4.patt'>
            <a-plane id='lab' src="statics/labirinto.jpg" scale="2 2 2" rotation="-90 0 0">
